...
- `lib/content.ts` — types (Skill, SkillGroup, ExperienceItem, Project, Certification, Profile, Settings) + hard-coded DEFAULTS; `CONTENT_KEYS` map. Content types: settings, **profile**, skills, experience, projects, certifications.
