      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto">
        ...
        >
          <motion.button
            ...
            className="group flex items-center gap-2 px-6 py-3 rounded-lg font-medium text-sm text-white transition-all"
            style={{
              background: "var(--accent)",
          ...
          <motion.a
            ...
            whileHover={{ scale: 1.03, y: -2 }}
            whileTap={{ scale: 0.97 }}
            className="flex items-center gap-2 px-6 py-3 rounded-lg font-medium text-sm border border-[var(--border)] bg-[var(--surface-1)] hover:border-[var(--accent)] transition-all"
          >
            <Download size={16} />
            Download Resume
          </motion.a>
